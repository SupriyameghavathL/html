defmodule GruppieWeb.SuggestionBox do
  use Ecto.Schema
  ...
  @fields [ :title, :text, :fileName, :video, :fileType, :thumbnail, :thumbnailImage ]



  schema "suggestionPost" do
    field :title, :string
    field :text, :string
  ...
  def suggestionPost(struct, params) do
    struct
    |> cast(params, @fields)
